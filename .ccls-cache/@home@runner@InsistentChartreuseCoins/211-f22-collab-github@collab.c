...
void jcruz85_sabus3() {
  ...
  printf("Juan Cruz and Sami Abu Shamat]\n");
  printf("We learned how to clone repositorys, and how to add files to the staging area\n");
  printf("We learned how to use the git commands such as git commit, git push, etc.\n");
